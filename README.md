...
- Seção de transporte aéreo para ida e volta do Brasil.
- Itens por destino separados por translados, hotel, passeios e alimentação.
...
- Linha do tempo clicável com modal de custos do destino.
